...
import { FiUser, FiShield, FiLink, FiSave, FiLock, FiArrowLeft } from 'react-icons/fi';
...
const SettingsView: React.FC<SettingsViewProps> = ({ user, onBack, onProfileUpdate }) => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center space-x-4 mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900">Perfil y Configuración</h2>
        </div>
                        ...
                        <form onSubmit={handleAvatarUpdate} className="space-y-4">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-grow">
                                    <label htmlFor="avatarUrl" className="text-sm font-medium text-slate-600">URL de la imagen</label>
                                    <div className="relative mt-1">
                                        <FiLink className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400"/>
                                        <input type="url" id="avatarUrl" placeholder="https://ejemplo.com/imagen.jpg" value={avatarUrl} onChange={(e) => setAvatarUrl(e.target.value)} className="w-full p-2.5 pl-10 rounded-lg bg-slate-50 border-2 border-slate-200 focus:border-sky-500 focus:ring-sky-500"/>
                                    </div>
                                </div>
                            </div>
